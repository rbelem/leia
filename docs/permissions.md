...
| `optional_host_permissions` | `http://localhost/*`, `http://127.0.0.1/*`, `https://api.openai.com/*`, `https://api.elevenlabs.io/*`, `https://*.speech.microsoft.com/*` | first use, prompted | provider APIs (ADR-0003) and local server profiles (ADR-0004). **Nothing network-related is asked at install** |
